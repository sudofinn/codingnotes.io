  ...
  return (
		<>
			<div className="bg-gray-50  mt-32 h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20">
				<div className="p-5  ">
					<ul>
						<p className="text-black hover:text-orange-600 duration-500 font-extrabold text-4xl pb-6">
							Coding<span className="text-blue-600 hover:text-green-500 duration-500">Notes</span>
						</p>
				...
				<div className="p-5 ">
					<ul>
						...
						<li  onClick={() => Router.push("/products")} className="text-gray-500 font-extrabold text-md pb-2  hover:text-blue-600 cursor-pointer">
							Notes, Flashcards
						</li>
						
						<li onClick={() => Router.push("/templates")} className="text-gray-500 text-md pb-2 font-extrabold  hover:text-blue-600 cursor-pointer">
							Templates
						</li>
						<li onClick={() => Router.push("/format")} className="text-gray-500 text-md pb-2 font-extrabold  hover:text-blue-600 cursor-pointer">
							Format & Third Party
