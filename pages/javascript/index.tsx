...
import Second from "../../assets/covers/javascript_2.png"
...
import Six from "../../assets/covers/javascript_6.png"
import Seven from "../../assets/covers/javascript_7.png"
import Eight from "../../assets/covers/javascript_8.png"
  ...
  return (
    ...
    <div>
     ...
     <div className='text-center'>
            <h1  data-aos="fade-up" className="text-7xl mt-8 font-extrabold">Add functionality- learn JavaScript </h1>
             <button className=" bg-yellow-400 shadow-md shadow-black text-white  px-8 py-6
     ...
     <div className="slide-container mx-32">
        ...
        <div className=''>
            ...
            <ul className=" list-disc ml-40 mt-8 text-4xl mr-64">
                      <li className="mt-6 mb-6">50+ Notion pages and 300+ Anki Flashcards.</li>
