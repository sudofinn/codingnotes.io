...
import LaptopMockup from "../../assets/covers/nextjs_mockup.png"
...
const Index = () => {
  ...
  function onlyNotesRoute() {
    Router.push("https://vimfinn.gumroad.com/l/next?option=XLvRPTpcer67OVm494mHUA%3D%3D&_gl=1*jvpqod*_ga*NjU1NjY0OTk2LjE2NDgwNjQ1Nzc.*_ga_6LJN6D94N6*MTY3MzYzNTMyMC4yODIuMS4xNjczNjM5NTAxLjAuMC4w&wanted=true")
  }

  function bothRoute() {
    Router.push("https://vimfinn.gumroad.com/l/next?wanted=true")
  }
  function onlyFlashcardsRoute() {
    Router.push("https://vimfinn.gumroad.com/l/next?option=YCaH2UfE09VYhbfk76PCEw%3D%3D&_gl=1*1nwfhc7*_ga*NjU1NjY0OTk2LjE2NDgwNjQ1Nzc.*_ga_6LJN6D94N6*MTY3MzYzNTMyMC4yODIuMS4xNjczNjM5NTI5LjAuMC4w&wanted=true")
  }
...
tailwind nextjs
   ...
   "></meta>
     ...
     <div className="slide-container  mt-8 lg:mt-0 mx-0 lg:mx-32  ">
        ...
        <div  data-aos-delay="100" className='mt-0 md:mt-32 xl:mt-0'>
         ...
         font-extrabold bg-white text-black hover:bg-gray-200 duration-500 rounded  ">A quick summary </h1>
            <ul className="  mt-8 text-2xl xl:text-4xl mx-[10px] sm:mx-[100px] lg:mx-[200px] xl:mx-[300px] 2xl:mx-[550px] ">
                      ...
                      <li className="mt-6 mb-6">15+ graphics and 20+ practical examples.</li >
                      <li className="mt-6 mb-6"> This includes every concept you need to know in order to master NextJS.</li >
        ...
        <button id="badge-dismiss-default" className=" mt-4 inline-flex  mb-8  items-center px-7  py-5  text-2xl font-bold bg-gray-300 hover:bg-gray-200 text-black rounded">
          Get Notion for free
        </button>
            </Link>
...
<Zoom>
	...
	<div className="container px-4 mx-auto">
		<div className="max-w-2xl mx-auto mb-16 text-center">
			<span className="font-bold tracking-wider uppercase text-gray-300">Pricing</span>
		...
		<div className="flex flex-wrap items-stretch -mx-4">
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-800 text-xl">
					...
					<p className="mt-3 leading-relaxed text-white">Detailed Notes for the framework NextJS.</p>
					<ul className="flex-1 mb-6 ">
						<li className="flex mb-2 space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#d1d5db" className="flex-shrink-0 w-6 h-6 ">
			...
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-300 text-gray-900 font-bold text-xl">
					<div className="space-y-2">
      ...
      <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-800 text-xl">
					...
					<button onClick={onlyFlashcardsRoute} type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-gray-300 hover:bg-gray-200 text-white">
            I want this !</button>
				</div>
			</div>
