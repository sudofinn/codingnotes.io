...
import Second from "../../assets/covers/nextjs_2.png"
import Third from "../../assets/covers/nextjs_3.png"
import Forth from "../../assets/covers/nextjs_4.png"
...
import Eight from "../../assets/covers/nextjs_8.png"
  ...
  return (
    ...
    <div>
     ...
     <div className='text-center'>
            <h1  data-aos="fade-up" className="text-7xl mt-8 font-extrabold">Learn the Nb.1 React Meta-Framework </h1>
             <button className=" bg-gray-200 shadow-md shadow-black text-white  px-8 py-6
