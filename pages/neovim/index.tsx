  ...
  return (
    ...
    <div>
     ...
     <div className='text-center'>
            <h1  data-aos="fade-up" className="text-7xl mt-8 font-extrabold">Learn the editors for the pros ! </h1>
             <button className=" bg-green-600 shadow-md shadow-black text-white  px-8 py-6
