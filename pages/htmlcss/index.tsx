...
const Index = () => {
  ...
  function onlyNotesRoute() {
    Router.push("https://vimfinn.gumroad.com/l/htmlcss?option=1rFbZEetUSf32P5RZ8qMfg%3D%3D&_gl=1*1hvhszp*_ga*NjU1NjY0OTk2LjE2NDgwNjQ1Nzc.*_ga_6LJN6D94N6*MTY3MDg2NDY3NS4xOTQuMS4xNjcwODY2MzI0LjAuMC4w&wanted=true")
  }

  function bothRoute() {
    Router.push("https://vimfinn.gumroad.com/l/htmlcss?wanted=true")
  }
  function onlyFlashcardsRoute() {
    Router.push("https://vimfinn.gumroad.com/l/htmlcss?option=T0h1Sg9nObNZtLPR-cy07Q%3D%3D&_gl=1*1a2sv6n*_ga*NjU1NjY0OTk2LjE2NDgwNjQ1Nzc.*_ga_6LJN6D94N6*MTY3MDg2NDY3NS4xOTQuMS4xNjcwODY2MzI0LjAuMC4w&wanted=true")
  }
   ...
   "></meta>
     ...
     <div className='text-center '>
      ...
      <NavBar />
            ...
            <h1   className="text-4xl lg:text-7xl mt-12  font-extrabold">Learn the Fundamentals - HTML and CSS </h1>

            <ModalVideo channel='youtube' isOpen={isOpen} videoId="Qc-nGIMv_SY"  onClose={() => setOpen(false)} />
             
        <button id="badge-dismiss-default"  onClick={()=> setOpen(true)} className="btn-primary inline-flex mt-8 mb-8  items-center px-10  py-5  text-2xl font-bold bg-orange-700 hover:bg-orange-600 text-black rounded">
     ...
     <div className="slide-container  mt-8 lg:mt-0 mx-0 lg:mx-32  ">
        ...
        <div  data-aos-delay="100" className='mt-0 md:mt-32 xl:mt-0'>
         ...
         font-extrabold bg-white text-black hover:bg-gray-200 duration-500 rounded  ">A quick summary </h1>
            <ul className="  mt-8 text-2xl xl:text-4xl mx-[10px] sm:mx-[100px] lg:mx-[200px] xl:mx-[300px] 2xl:mx-[550px] ">
                      ...
                      <li className="mt-6 mb-6"> This includes every concept you need to know in order to master HTML and CSS.</li >
        ...
        <button id="badge-dismiss-default" className=" mt-4 inline-flex  mb-8  items-center px-7  py-5  text-2xl font-bold bg-orange-700 hover:bg-orange-600 text-black rounded">
          Get Notion for free
        </button>
            </Link>
      ...
      <Link href="/notesandflashcards" target="_blank">
         ...
         font-extrabold bg-white text-black hover:bg-gray-200 duration-500 rounded">How to start 🖱️ </h1>
            ...
            <Link href="https://apps.ankiweb.net/" target="_blank">
             <button id="badge-dismiss-default" className=" mt-4 inline-flex  mb-8  items-center px-7  py-5  text-2xl font-bold bg-blue-600 hover:bg-blue-500 text-black rounded">
          Get Anki here 
        </button>
            </Link>
            </Zoom>
...
<Zoom>
	...
	<div className="container px-4 mx-auto">
		<div className="max-w-2xl mx-auto mb-16 text-center">
			<span className="font-bold tracking-wider uppercase text-blue-500">Pricing</span>
		...
		<div className="flex flex-wrap items-stretch -mx-4">
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-800 text-xl">
					...
					<p className="mt-3 leading-relaxed text-white">Detailed Notes for the languages HTML and CSS.</p>
					<ul className="flex-1 mb-6 ">
						<li className="flex mb-2 space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#2563eb" className="flex-shrink-0 w-6 h-6 ">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
							</svg>
							<span>70+ Notion Pages</span>
						</li>
						<li className="flex mb-2 space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#2563eb" className="flex-shrink-0 w-6 h-6 ">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
							</svg>
							<span>40+ visuals/graphics</span>
						</li>
						<li className="flex mb-2 space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#2563eb" className="flex-shrink-0 w-6 h-6 ">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
							</svg>
							<span>25+ real-world examples</span>
						</li>
					</ul>
					<button onClick={onlyNotesRoute} type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-orange-700 hover:bg-orange-600 ">
            I want this !</button>
				</div>
			</div>
			<div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-blue-600 text-gray-900 font-bold text-xl">
					<div className="space-y-2">
						<h4 className="text-2xl font-bold">Both</h4>
						<span className="text-6xl font-bold">$9
						</span>
					</div>
					<p className="leading-relaxed"> Detailed Notes and extensive Flashcards for HTML and CSS.</p>
      ...
      <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-800 text-xl">
					<div className="space-y-2">
						...
						<span className="text-6xl font-bold">$6
						</span>
					</div>
					<p className="leading-relaxed"> Extensive Flashcards for the languages HTML and CSS.</p>
					<ul className="flex-1 space-y-2">
						
						<li className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#ea580c" className="flex-shrink-0 w-6 h-6">
								<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
							</svg>
							<span>500+ Anki Flashcards</span>
						</li>
					...
					<button onClick={onlyFlashcardsRoute} type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-blue-600 hover:bg-blue-500 text-white">
            I want this !</button>
				</div>
			</div>
