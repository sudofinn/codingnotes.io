  ...
  return (
    ...
    <div>
     ...
     <div className='text-center'>
            <h1  data-aos="fade-up" className="text-7xl mt-8 font-extrabold">Complete Focus OS </h1>
             <button className=" bg-gray-300 shadow-md shadow-black text-white  px-8 py-6
        ...
        <div className=''>
            ...
            <ul className=" list-disc ml-40 mt-8 text-4xl mr-64">
                      ...
                      <button className="text-black shadow-md text-2xl  dark:bg-black dark:text-white px-7 py-5
                            ...
                            bg-gradient-to-r from-gray-300  to-black-600 hover:from-black hover:to-gray-300 hover:shadow-xl hover:shadow-black  hover:bg-white
                            ">
